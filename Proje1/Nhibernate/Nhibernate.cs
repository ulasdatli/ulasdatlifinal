    ...
    public class NhibernateHelper
    {
        ...
        private static ISessionFactory SessionFactory
        {
            get
            {
                if (_sessionFactory == null)
                {
                    ...
                    configuration.AddDeserializedMapping(mapping, "projeodev");
        ...
        public static void Setup()
        {
            ...
            try
            {
                ...
                var mapping = GetMappings();
                NhConfiguration.AddDeserializedMapping(mapping, "projeodev");
        ...
        {
            //log.Warn("Check DB");
            if (System.IO.File.Exists(exctLcl + "\\projeodev.db")) return;
            SQLiteConnection.CreateFile(exctLcl + "\\projeodev.db");
            using (var cn = new SQLiteConnection("Data Source=" + exctLcl + "\\projeodev.db;Version=3;Password=;PRAGMA journal_mode=WAL;"))
            {
        ...
        public static Configuration ConfigureNhibernate()
        {
            ...
            configure.DataBaseIntegration(db =>
            {
                ...
                db.ConnectionString = "Data Source=" + exctLcl + "//projeodev.db;Version=3;PRAGMA journal_mode=WAL;";
            });
